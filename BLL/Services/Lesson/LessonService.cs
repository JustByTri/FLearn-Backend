        ...
        public async Task<BaseResponse<LessonResponse>> CreateLessonAsync(Guid userId, Guid unitId, LessonRequest request)
        {
            try
            {
                ...
                var response = new LessonResponse
                {
                    ...
                    TotalExercises = newLesson.TotalExercises,
                    ...
                    CreatedAt = newLesson.CreatedAt.ToString("dd-MM-yyyy"),
                    UpdatedAt = newLesson.UpdatedAt.ToString("dd-MM-yyyy")
                };
        ...
        public async Task<BaseResponse<LessonResponse>> GetLessonByIdAsync(Guid lessonId)
        {
            try
            {
                ...
                var response = new LessonResponse
                {
                    ...
                    CourseID = (lesson.CourseUnit != null) ? lesson.CourseUnit.CourseID : Guid.Empty,
                    TotalExercises = lesson.TotalExercises,
                    CourseTitle = (lesson.CourseUnit != null && lesson.CourseUnit.Course != null) ? lesson.CourseUnit.Course.Title : "No title provided",
                    CourseUnitID = lesson.CourseUnitID,
                    UnitTitle = lesson.CourseUnit?.Title,
                    CreatedAt = lesson.CreatedAt.ToString("dd-MM-yyyy"),
                    UpdatedAt = lesson.UpdatedAt.ToString("dd-MM-yyyy")
                };
        ...
        public async Task<BaseResponse<LessonResponse>> UpdateLessonAsync(Guid userId, Guid unitId, Guid lessonId, LessonUpdateRequest request)
        {
            try
            {
                ...
                var response = new LessonResponse
                {
                    ...
                    TotalExercises = existingLesson.TotalExercises,
                    ...
                    CourseUnitID = selectedUnit.CourseUnitID,
                    UnitTitle = selectedUnit.Title,
                    CreatedAt = existingLesson.CreatedAt.ToString("dd-MM-yyyy"),
                    UpdatedAt = existingLesson.UpdatedAt.ToString("dd-MM-yyyy")
                };
