    ...
    public class ExerciseService : IExerciseService
    {
        ...
        public async Task<BaseResponse<ExerciseResponse>> CreateExerciseAsync(Guid userId, Guid lessonId, ExerciseRequest request)
        {
            try
            {
                ...
                int nextPosition = selectedLesson.Exercises.Any() ? selectedLesson.Exercises.Max(e => e.Position) + 1 : 1;
                Guid? prerequisiteExerciseId = null;
                if (selectedLesson.Exercises.Any())
                {
                    var lastExercise = selectedLesson.Exercises
                ...
                if (result <= 0)
                {
                    ...
                    return BaseResponse<ExerciseResponse>.Fail("Failed when creating exercise.");
                }
        ...
        public async Task<BaseResponse<ExerciseResponse>> GetExerciseByIdAsync(Guid exerciseId)
        {
            try
            {
                ...
                var response = new ExerciseResponse
                {
                    ...
                    MediaPublicId = exercise.MediaPublicId,
        ...
        public async Task<BaseResponse<ExerciseResponse>> UpdateExerciseAsync(Guid userId, Guid lessonId, Guid exerciseId, ExerciseUpdateRequest request)
        {
            try
            {
                ...
                var response = new ExerciseResponse
                {
                    ...
                    MediaUrl = selectedExercise.MediaUrl,
                    MediaPublicId = selectedExercise.MediaPublicId,
                    ...
                    LessonID = selectedLesson.LessonID,
                    LessonTitle = selectedLesson.Title,
                    PrerequisiteExerciseID = selectedExercise.PrerequisiteExerciseID,
                    CreatedAt = selectedExercise.CreatedAt,
                    UpdatedAt = selectedExercise.UpdatedAt
                };
